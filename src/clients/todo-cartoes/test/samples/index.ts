...
export const fetchProductsResponse = [
  ...
  },
  {
    ...
    brand_name: 'MOCK 1',
    logo_url:
      'https://media.istockphoto.com/id/1354697451/pt/vetorial/modern-vip-bank-card-with-world-map-vector-mockup.jpg?s=612x612&w=0&k=20&c=t5p3A50RP5OOugfZscPXmmBph5xzSlSB-bZopzlXsEE=',
    product_line_description: 'About this Product Line Text',
    subscription: false,
    updated_at: '2023-11-27T16:40:54.770-03:00',
    terms_and_conditions: 'Terms & Conditions Dummy Product DDP',
