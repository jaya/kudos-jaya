import openPrizesReportHandler from '../../../handlers/slack/open-prizes-report';
import * as prizesReportModal from '../../../ui/slack/prizes-report-modal';

jest.mock('../../../ui/slack/prizes-report-modal');
